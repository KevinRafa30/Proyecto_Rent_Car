...
urlpatterns = [
    ...
    path('rentas/', views.renta_list, name='renta_list'),
    path('renta/nueva/', views.registrar_renta, name='registrar_renta'),
    path('renta/editar/<int:pk>/', views.edit_renta, name='edit_renta'),
    path('renta/eliminar/<int:pk>/', views.delete_renta, name='delete_renta'),
